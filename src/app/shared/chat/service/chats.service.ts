...
import {BACKEND_CHAT_ENDPOINT, BACKEND_ENDPOINT, BACKEND_URI, BACKEND_USER_ENDPOINT} from '@core/constant/url.constant';
...
export class ChatService {
  ...
  public startChatWithUser(user_mail: string): Observable<void> {
    return this.http.post<void>(this.new_chat_url, {user_email: user_mail}, {withCredentials: true});
  }
}
